...
def to_datetime(
    ...
    field_map: dict[str, Literal["CE", "year", "month", "WK", "day", "hour", "minute", "second"]] = {
        "CE": "CE",
        "YR": "year",
        "MO": "month",
        "WK": "WK",
    ...
    fields: dict[Literal["CE", "year", "month", "WK", "day", "hour", "minute", "second"], int] = {
